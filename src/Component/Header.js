      ...
      <nav id="navmenu" className="navmenu">
        <ul>
          ...
          <li className="dropdown">
            <a href="#"><i className="bi bi-menu-button navicon"></i> Dropdown <i className="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="#">Dropdown 1</a></li>
              <li className="dropdown">
                <a href="#">Deep Dropdown <i className="bi bi-chevron-down toggle-dropdown"></i></a>
                <ul>
